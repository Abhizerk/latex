...
\begin{figure}[H]
 \centering
 \includegraphics[height= 12cm, width=12cm]{images/colb.png}
 \caption{\textbf{Fig. Name}}
\end{figure}
Description
...
\begin{figure}[H]
 \centering
 \includegraphics[height= 12cm, width=12cm]{images/activity1.png}
...
\begin{figure}[H]
 \centering
 \includegraphics[height= 18cm, width=17cm]{images/otputt.png}
